...
shared(msg) actor class Defi(
    ...
    private var free_zed_token : Nat = 100;
    private var free_yasuo_token : Nat = 5;

    private var zedPool : Nat = 1000000;
    private var yasuoPool : Nat = 100000;
    ...
    // booking
    private var hotel_principal: Principal = Principal.fromText("oari7-j2rfo-jopj5-afibt-usulk-hhyw3-gh3nj-h6562-qb7hv-idzxc-iqe");
